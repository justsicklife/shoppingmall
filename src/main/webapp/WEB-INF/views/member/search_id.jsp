...
<style>
.find_id_link:hover,.find_id_link:visited,.find_id_link:active{
    color: #0d6efd;
                    ...
                    <div class="card-body">
                        <form action="/member/findId.do" method="post">
                            <div class="mb-3">
                                ...
                                <input type="name" class="form-control" id="name" name="memberName" required>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="mt-3 text-center">
                            <a class="find_id_link" href="/member/loginPage">로그인으로 돌아가기</a>
                        </div>
                    </div>
                </div>
            </div>
